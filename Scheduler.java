...
public class Scheduler {
	...
	Scheduler() {
		steps=0;
		//conf=new ExperimentRunConfiguration(100,1,3); // Round Robin
		//conf=new ExperimentRunConfiguration(100,2,3); // Longest stay
		conf=new ExperimentRunConfiguration(20,3,3,100, 500);
...
*/
	...
	public void execute(int day) { //day is the step of simulation
		...
		try {
			...
			String[] row;
			//policyOfAssignment=1 Round Robin
			//policyOfAssignment=2 Longest stay
			//policyOfAssignment=3 Shortest stay
